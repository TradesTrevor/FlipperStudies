...
- Extends TheFlipper with a dynamic delta threshold calculated using standard deviation over a lookback period.
- Incorporates RSI-based confirmation using CVD data.
- Provides debug logging for dynamic threshold calculations.
- Flexible confirmation settings and visual markers for strong/weak flips.
